...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=519423811624370179&permissions=8&scope=bot')
  .setDescription(`**
  New Server Add FireBot ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("519422885358600192").sendEmbed(embed)
});
...
if (message.content.startsWith('>bcall')){
 if (message.author.id !== '498947642110509067') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
const adminprefix = "-";
const devs = ['498947642110509067','498947642110509067'];
client.on('message', message => {
...
client.users.get("498947642110509067","498947642110509067").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=499941757128146946&permissions=8&scope=bot`)
